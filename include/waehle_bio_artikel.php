...
$select_e_artikel_bio=mysqli_query($link," select art_nr from $db_e_preis where bio_id = '1'  and laender_kennung = '$_COOKIE[laender_kennung]' ");
while ( $result_e_artikel_bio = mysqli_fetch_array( $select_e_artikel_bio, MYSQLI_BOTH )) {
$gekuerztbio=substr("$result_e_artikel_bio[art_nr]",4,4);
$gekuerzt_bio[]=$gekuerztbio;
}
