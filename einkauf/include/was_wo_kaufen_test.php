...
$select_minpreis=mysqli_query($link, "select preis_id, packungsgroesse, einheit, preis, hundert_g_preis from $db_e_preis where art_nr like '%$artikel_nummer' order by hundert_g_preis desc limit 1 ");
