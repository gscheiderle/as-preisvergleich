...
?>
    ...
    <form action="artikel_eingabe_am_pc.php" method="POST">
...
<?php echo "<p>$keine_kategorie</p>"; ?>
 ...
 <p>      
	 <input type="search" name="neue_artikel_3" placeholder="unbek. Artikel im Warenkorb" list="neue_artikel_3" style="width: 700px; height: 70px; font-size: 36px;" tabindex="11">
...
echo  "<br>
      ...
      <br><br>          
      <button type='submit' value='neuenartikelloeschen_3' name='neuen_artikel_loeschen_3' tabindex='19' width='200px'>Neuen Artikel l&ouml;schen</button>";
?>
...
<?php 
 ...
 echo "<br>
      <a href='einkauf/index.php?einkaufszettel_zeigen=$oeffnen'><h2>Zur&uuml;ck<br>zum Einkaufszettel</a>
      <br>";
